...
def operate_gripper():
    ...
    while not rospy.is_shutdown():
        Robotiq.goto(robotiq_client, pos=0.02, speed=0.1, force=100 , block=True)
        Robotiq.goto(robotiq_client, pos=0.04, speed=0.1, force=10)
        Robotiq.goto(robotiq_client, pos=0.011, speed=0.01, force=0 , block=True)
        Robotiq.goto(robotiq_client, pos=0.08, speed=0.01, force=200 , block=True)
